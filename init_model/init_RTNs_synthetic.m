function net = init_RTNs_synthetic()
    maxdisp = 9;
    ...
    for i = 1:26
        net_vgg_first.params(i).learningRate = 0;
    end
    ...
    for i = 1:2
        net_vgg_last.params(i).learningRate = 0;
    end
    ...
    for i = 1:2
        net_vgg_last1.params(i).learningRate = 0;
    end
    ...
    net.addLayer('iter1_f2_transform', Transformer_Flow_Layer(), {'f2_x28','comp_init_aff_transform'}, {'iter1_f2_last1_input'}); 
    ...
    net.addLayer('iter2_f2_transform', Transformer_Flow_Layer(), {'f2_x19','comp_iter1_aff_transform_'}, {'iter2_f2_last_input'}); 
    ...
    net.addLayer('iter3_f2_transform', Transformer_Flow_Layer(), {'f2_x19','comp_iter2_aff_transform'}, {'iter3_f2_last_input'}); 
    ...
    net.addLayer('iter4_f2_transform', Transformer_Flow_Layer(), {'f2_x19','comp_iter3_aff_transform'}, {'iter4_f2_last_input'}); 
    ...
    %% GT L1 Loss
    net.addLayer('objective1', Loss_GT_wVisualization(), {'comp_iter4_flow_transform','label','img1','img2_transform','img2'}, 'objective1');
