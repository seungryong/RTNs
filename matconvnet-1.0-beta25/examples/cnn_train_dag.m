...
%     maxdisp = 9;
% 	net.addLayer('feat_transform4', Feature_transform_layer(), {'f2_level3','comp_iter3_aff_transform_x8'}, {'iter4_f2_level3'});
% 	net.addLayer('iter4_corr_volume', Correlation_layer('max_disp',maxdisp,'stride',1), {'f1_level3','iter4_f2_level3'},{'iter4_corr_vol_x8'});    
%     net.removeLayer(net.layers(274).name);
%     net.addLayer('objective1', Loss_wVisualization('loss', 'softmaxlog'), {'iter4_corr_vol_x8','label_x8','img1','img2_transform','img2'}, 'objective1');
